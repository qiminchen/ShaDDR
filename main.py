...
parser.add_argument("--train_geo", action="store_true", dest="train_geo", default=False, help="True for training geometry [False]")
parser.add_argument("--train_tex", action="store_true", dest="train_tex", default=False, help="True for training texture [False]")
parser.add_argument("--test", action="store_true", dest="test", default=False, help="True for rough testing [False]")
parser.add_argument("--test_geo", action="store_true", dest="test_geo", default=False, help="True for rough testing geometry [False]")
parser.add_argument("--test_tex", action="store_true", dest="test_tex", default=False, help="True for rough testing texture [False]")
...
parser.add_argument("--prepvoxcoarse", action="store_true", dest="prepvoxcoarse", default=False, help="True for preparing coarse voxels for visualization")
...
parser.add_argument("--preptexstyle", action="store_true", dest="preptexstyle", default=False, help="True for preparing style texture images")
...
parser.add_argument("--prepimgreal", action="store_true", dest="prepimgreal", default=False,
                    help="True for preparing rendered views of all content shapes (as real) for evaluating Cls_score [False]")
...
parser.add_argument("--prepFIDreal", action="store_true", dest="prepFIDreal", default=False,
                    help="True for computing the mean and sigma vectors (real) for evaluating FID [False]")
...
if FLAGS.train:
    im_ae = IM_AE(FLAGS)
    if FLAGS.train_geo:
        im_ae.train_geometry(FLAGS)
    elif FLAGS.train_tex:
        if FLAGS.asymmetry:
            im_ae.train_texture_asymmetry(FLAGS)
        else:
            im_ae.train_texture(FLAGS)
    else:
        print('?!')
    ...
    im_ae = IM_AE(FLAGS)
    if FLAGS.test_geo:
        im_ae.test_geometry(FLAGS)
    elif FLAGS.test_tex:
        im_ae.test_texture(FLAGS)
    else:
        print('?!')

elif FLAGS.prepvox:
    im_ae = IM_AE(FLAGS)
    im_ae.prepare_content_voxel_for_visualization(FLAGS)
...
elif FLAGS.preptexstyle:
    im_ae = IM_AE(FLAGS)
    im_ae.prepare_style_texture_images(FLAGS)
