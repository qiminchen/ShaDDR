...
def eval_Cls_score(config):
    ...
    for epoch in range(training_epoch):
        ...
        print("Epoch: [%2d/%2d] time: %4.4f, real_score: %.8f, fake_score: %.8f" % (
        epoch, training_epoch, time.time() - start_time, avg_real_score / avg_num, avg_fake_score / avg_num))
